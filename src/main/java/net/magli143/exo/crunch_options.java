...
/**
 * <i>native declaration : exo_helper.h:901</i><br>
...
public class crunch_options extends Structure {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("exported_encoding", "max_passes", "max_offset", "use_literal_sequences");
	}
	/** @param exported_encoding C type : const char* */
	public crunch_options(Pointer exported_encoding, int max_passes, int max_offset, int use_literal_sequences) {
		super();
